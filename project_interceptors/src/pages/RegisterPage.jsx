...
const RegisterPage = () => {
  let { register, reset, registerFormSubmit, handleSubmit, navigate, watch, errors } = useAuth();
        ...
        <form onSubmit={handleSubmit(registerFormSubmit)} className="space-y-5">
          ...
          <div>
            ...
            {errors.confirmPassword && (
              <p className="text-red-700 text-sm mt-1">{errors.confirmPassword.message}</p>
            )}
          </div>
