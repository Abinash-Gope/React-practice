  ...
  return (
    <div className="flex justify-between items-center bg-black text-white p-3">
      ...
      <div className="flex gap-5 items-center">
        ...
        <button className="flex items-center gap-1.5 px-3 py-1.5 bg-gray-500/30 border hover:border-yellow-500 hover:bg-black hover:text-yellow-500 text-white/80 text-xs font-semibold rounded-md shadow-sm transition-all duration-300 active:scale-[0.97] cursor-pointer">
          <svg
            xmlns="http://w3.org"
            fill="none"
            viewBox="0 0 24 24"
